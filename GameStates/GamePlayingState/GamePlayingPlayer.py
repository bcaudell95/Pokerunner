...
class GamePlayingPlayer:
    ...
    def calculateHeightOfJump(self):
        ...
        height = GamePlayingPlayer.PARABOLA_COEFF * (frameCount) * (
        frameCount - GamePlayingPlayer.TOTAL_FRAMES_PER_SHEET)
...
def createSheetForElement(element):
    return FormSheet(Elements.getElementSheetFile(element.name))
